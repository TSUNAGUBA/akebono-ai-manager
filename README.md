...
| 機能 | 内容 |
|---|---|
| 朝の問いかけ(M2) | 平日朝、タスク状況を踏まえた3つの問いを DM で配信(対象はユーザー単位で設定可 — v0.8)。答えるうちに仮説が言語化される |
...
| マスタ管理(v0.3/v0.8/v0.9) | 業界・顧客(エイリアス含む)・顧客間関係・関係種別・プロジェクトの各マスタと、ユーザー単位の問いかけ可否をダッシュボードから管理(管理者限定。要 DB_ADMIN_USER / DB_ADMIN_PASSWORD) |
